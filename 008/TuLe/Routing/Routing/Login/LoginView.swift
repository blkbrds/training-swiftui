                ...
                Image("logo")
                    ...
                    .onAppear {
                        withAnimation(Animation.easeInOut(duration: 1)) {
                            viewModel.logoScale = 1.0
                            viewModel.opacityTitle = 1.0
                        }
                    }
                
                Text("Login")
                    .font(.system(size: 32, weight: .bold))
                    .opacity(viewModel.opacityTitle)
                    .onAppear {
                        withAnimation(Animation.easeInOut(duration: 1).delay(1.0)) {
                            viewModel.opacityTitle = 1.0
                        }
                    }
                if viewModel.opacityTitle == 1.0 {
                    ...
                    .animation(Animation.default.delay(viewModel.isDelay ? 2 : 0))
                    .transition(.slide)
                    .onAppear {
                        viewModel.isDelay.toggle()
                    }
                    ...
                    .animation(Animation.default.delay(viewModel.isDelay ? 2 : 0))
                    .transition(AnyTransition.move(edge: .bottom).combined(with: .opacity).animation(Animation.default.delay(viewModel.isDelay ? 2 : 0)))
                }
            }
        }
    }
